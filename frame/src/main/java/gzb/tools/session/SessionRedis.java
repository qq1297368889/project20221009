...
public class SessionRedis implements Session{
    public static Lock lock=new ReentrantLock();
    public static GzbCache gzbCache = new GzbCacheRedis();
    String id;
    //有效 秒数 不支持 小于0的数值
    long mm;

    public SessionRedis(HttpServletRequest request,HttpServletResponse response,long mm){
